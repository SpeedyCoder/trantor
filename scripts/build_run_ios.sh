...
APP_PATH="src-tauri/gen/apple/build/${APP_ARCH_DIR}/Trantor.app"
if [[ ! -d "$APP_PATH" ]]; then
  FALLBACK_APP="$(find src-tauri/gen/apple/build -maxdepth 3 -type d -name 'Trantor.app' | head -n 1 || true)"

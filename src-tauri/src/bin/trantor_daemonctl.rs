...
const EXPECTED_DAEMON_NAME: &str = "trantor-daemon";
...
const APP_IDENTIFIER: &str = "com.dimillian.trantor";
...
LISTEN 0      4096   0.0.0.0:4732      0.0.0.0:*    users:(("trantor-da",pid=12345,fd=7))
"#;
...
tcp        0      0 0.0.0.0:4732            0.0.0.0:*               LISTEN      6789/trantor-da
"#;

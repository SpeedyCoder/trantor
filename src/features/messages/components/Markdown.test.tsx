...
describe("Markdown file-like href behavior", () => {
  ...
  it("still intercepts dotless workspace file hrefs when a file opener is provided", () => {
    ...
    render(
      <Markdown
        value="See [license](/workspace/Trantor/LICENSE)"
        className="markdown"
        workspacePath="/Users/sotiriskaniras/Documents/Development/Forks/Trantor"
        onOpenFileLink={onOpenFileLink}
      />,
    );

    const link = screen.getByText("license").closest("a");
    expect(link?.getAttribute("href")).toBe("/workspace/Trantor/LICENSE");
    ...
    fireEvent(link as Element, clickEvent);
    expect(clickEvent.defaultPrevented).toBe(true);
    expectOpenedFileTarget(onOpenFileLink, "/workspace/Trantor/LICENSE");
  });
  ...
  it("still intercepts nested workspace file hrefs when a file opener is provided", () => {
    ...
    render(
      <Markdown
        value="See [src](/workspaces/team/Trantor/src)"
        className="markdown"
        workspacePath="/Users/sotiriskaniras/Documents/Development/Forks/Trantor"
        onOpenFileLink={onOpenFileLink}
      />,
    ...
    expect(link?.getAttribute("href")).toBe("/workspaces/team/Trantor/src");
    ...
    fireEvent(link as Element, clickEvent);
    expect(clickEvent.defaultPrevented).toBe(true);
    expectOpenedFileTarget(onOpenFileLink, "/workspaces/team/Trantor/src");
  });
  ...
  it("intercepts Windows absolute file hrefs with #L anchors and preserves the tooltip", () => {
    ...
    const linkedPath =
      "I:\\gpt-projects\\Trantor\\src\\features\\settings\\components\\sections\\SettingsDisplaySection.tsx#L422";
    render(
      <Markdown
    ...
    expect(link?.getAttribute("href")).toBe(
      "I:%5Cgpt-projects%5CTrantor%5Csrc%5Cfeatures%5Csettings%5Ccomponents%5Csections%5CSettingsDisplaySection.tsx#L422",
    );
    expect(link?.getAttribute("title")).toBe(
      "I:\\gpt-projects\\Trantor\\src\\features\\settings\\components\\sections\\SettingsDisplaySection.tsx:422",
    );
    ...
    expectOpenedFileTarget(
      onOpenFileLink,
      "I:\\gpt-projects\\Trantor\\src\\features\\settings\\components\\sections\\SettingsDisplaySection.tsx",
      422,
    );
    ...
    expect(onOpenFileLinkMenu).toHaveBeenCalledWith(
      expect.anything(),
      {
        path: "I:\\gpt-projects\\Trantor\\src\\features\\settings\\components\\sections\\SettingsDisplaySection.tsx",
        line: 422,
        column: null,
      },
    );

...
describe("useFileLinkOpener", () => {
  ...
  it("maps /workspace root-relative paths to the active workspace path", async () => {
    const workspacePath = "/Users/sotiriskaniras/Documents/Development/Forks/Trantor";
    ...
    expect(openWorkspaceInMock).toHaveBeenCalledWith(
      "/Users/sotiriskaniras/Documents/Development/Forks/Trantor/src/features/messages/components/Markdown.tsx",
  ...
  it("maps /workspace/<workspace-name>/... paths to the active workspace path", async () => {
    ...
    await act(async () => {
      await result.current.openFileLink(fileTarget("/workspace/Trantor/LICENSE"));
    });

    expect(openWorkspaceInMock).toHaveBeenCalledWith(
      "/Users/sotiriskaniras/Documents/Development/Forks/Trantor/LICENSE",
      expect.objectContaining({ appName: "Visual Studio Code", args: [] }),
    );
  });
  ...
  it("maps nested /workspaces/.../<workspace-name>/... paths to the active workspace path", async () => {
    ...
    await act(async () => {
      await result.current.openFileLink(fileTarget("/workspaces/team/Trantor/src"));
    });

    expect(openWorkspaceInMock).toHaveBeenCalledWith(
      "/Users/sotiriskaniras/Documents/Development/Forks/Trantor/src",
      expect.objectContaining({ appName: "Visual Studio Code", args: [] }),
    );
  });
  ...
  it("parses #L line anchors before opening the editor", async () => {
    ...
    expect(openWorkspaceInMock).toHaveBeenCalledWith(
      "/Users/sotiriskaniras/Documents/Development/Forks/Trantor/src/App.tsx",
      expect.objectContaining({
        appName: "Visual Studio Code",
        args: [],
        line: 33,
